<template>
  <div class="dashboard-container">
    <div class="container">
      <div class="tableBar">
        <label style="margin-right: 10px">组合名称：</label>
        ...
        <label style="margin-right: 10px; margin-left: 20px">组合分类：</label>
        ...
        <label style="margin-right: 10px; margin-left: 20px">上架状态：</label>
  ...
  private statusHandle(row: any) {
    ...
    this.$confirm('确认更改该组合状态?', '提示', {
      ...
      setmealStatusByStatus(params)
        .then(res => {
          if (res.data.code === 1) {
            this.$message.success('组合状态已更改成功！')
            this.init()
          } else {
            this.$message.error(res.data.msg)
          }
